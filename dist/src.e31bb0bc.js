...
function block(type) {
  return "\n      <form name=\"".concat(type, "\">\n        <h5>").concat(type, "</h5>\n        <div class=\"form-group\">\n          <input class=\"form-control form-control-sm mb-2\" name=\"value\" placeholder=\"value\">\n        </div>\n        <div class=\"form-group\">\n          <input class=\"form-control form-control-sm mb-2\" name=\"styles\" placeholder=\"styles\">\n        </div>\n        <div class=\"form-group justify-content-md-end\">\n            <button type=\"submit\" class=\"btn btn-primary btn-sm\">Add element</button>\n        </div>\n      </form>\n      <hr />\n    ");
}
...
var TitleBlock = /*#__PURE__*/function (_Block) {
  ...
  _createClass(TitleBlock, [{
    key: "toHTML",
    value: function toHTML() {
      var _this$options$tag;

      var tag = (_this$options$tag = this.options.tag) !== null && _this$options$tag !== void 0 ? _this$options$tag : 'h1';
  ...
  _createClass(ImageBlock, [{
    ...
    value: function toHTML() {
      var _this$options = this.options,
          ...
          _this$options$alt = _this$options.alt,
          alt = _this$options$alt === void 0 ? '' : _this$options$alt;
      return (0, _utils.row)("<img src=\"".concat(this.value, "\" style=\"").concat((0, _utils.css)(is), "\" alt=\"").concat(alt, "\"\"/>"), (0, _utils.css)(styles));
    }
  }]);
...
var model = [new _blocks.TitleBlock('Lorem ipsum dolor sit amet consectetur adipisicing elit', {
  tag: 'h2',
  ...
  alt: 'white bear pic'
}), new _blocks.ColumnsBlock(['Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic dignissimos aliquam laborum exercitationem tempora suscipit labore provident, facere, aliquid fugit est in, earum atque magnam natus voluptatem voluptatum voluptas quae modi minima nobis omnis id maiores?', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic dignissimos aliquam laborum exercitationem tempora suscipit labore provident, facere, aliquid fugit est in, earum atque magnam natus voluptatem voluptatum voluptas quae modi minima nobis omnis id maiores?', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic dignissimos aliquam laborum exercitationem tempora suscipit labore provident, facere, aliquid fugit est in, earum atque magnam natus voluptatem voluptatum voluptas quae modi minima nobis omnis id maiores?'], {
  styles: {
...
new _app.App(_model.model).init(); //let html =''
